...
internal class ImageShader(context: Context) {
    private val mVertexShader: String = ShaderUtils.readRawTextFile(context, R.raw.image_vertex_shader)!!
    private val mFragmentShader: String = ShaderUtils.readRawTextFile(context, R.raw.image_fragment_shader)!! +
